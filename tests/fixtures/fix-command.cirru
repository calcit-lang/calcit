...
{}
  ...
  :entries $ {} $ :default
    {}
      :description "|Compiler-guided source fix fixture."
      :init-fn 'fix-command.main/main!
      :mode :native
      :reload-fn 'fix-command.main/reload!
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
    ...
    %{} 'FileEntry
      :defs $ {}
        ...
        'FixPersonChoice $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defenum FixPersonChoice
            :person 'fix-command.main/FixPerson
            :none
          :examples $ []
          :schema $ :: 'EnumDef
        'ambiguous $ %{} 'CodeEntry
          :doc "|Removed predicate needs a semantic choice."
        ...
        'defaulted-struct-field $ %{} 'CodeEntry (:doc |)
          ...
          :tests $ [] $ %{} 'TestEntry
            :name |keeps-business-default-path
        ...
        'legacy-nested $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {}
            ...
            :args $ []
          :tests $ [] $ %{} 'TestEntry
            :name |composes-constructor-and-do-migrations
            :code $ quote $ assert=
              FixPersonChoice :person $ FixPerson :name |Ada :age 1
              legacy-nested
            :tags $ #{} :migration
        ...
        'macro-origin-struct-field $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {} (:return 'String)
            :args $ [] 'fix-command.main/FixPerson
          :tests $ [] $ %{} 'TestEntry
            :name |keeps-ambiguous-macro-origin
            :code $ quote $ assert= |Ada
        ...
        'make-fix-person $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn make-fix-person ()
            swap! *fix-person-calls inc
            FixPerson :name |Ada :age 1
          :examples $ []
          :schema $ :: 'Fn $ {}
            :return 'fix-command.main/FixPerson
        ...
        'quoted-legacy-constructor $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ []
          :tests $ [] $ %{} 'TestEntry
            :name |preserves-quoted-constructor-data
            :code $ quote $ assert=
              quote $ %:: FixPersonChoice :none
        ...
        'required-struct-complex $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {} (:return 'String)
            :args $ []
          :tests $ [] $ %{} 'TestEntry
            :name |evaluates-complex-receiver-once
            :code $ quote $ do
              reset! *fix-person-calls 0
        ...
        'union-struct-field $ %{} 'CodeEntry (:doc |)
          ...
          :tests $ [] $ %{} 'TestEntry
            :name |keeps-enum-union-receiver
            :code $ quote $ assert= (%none)
        ...
        'unknown-struct-field $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ [] 'Dynamic
          :tests $ [] $ %{} 'TestEntry
            :name |keeps-unknown-field-for-review
            :code $ quote $ assert= (%none)
              unknown-struct-field $ FixPerson :name |Ada :age 1
            :tags $ #{} :migration
      :ns $ %{} 'NsEntry
        :doc "|Fix command fixture."
