...
impl FromStr for CalcitProc {
  ...
  fn from_str(s: &str) -> Result<Self, Self::Err> {
    match s {
      ...
      "generate-id!" => Ok(Self::NativeGenerateId),
      "turn-symbol" => Ok(Self::TurnSymbol),
      "turn-keyword" => Ok(Self::TurnKeyword),
...
impl Display for CalcitProc {
  fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
    match self {
      ...
      Self::NativeResetGenSymIndex => write!(f, "&reset-gen-sym-index"),
      Self::NativeGetCalcitRunningMode => write!(f, "&get-calcit-running-mode"),
      Self::NativeGenerateId => write!(f, "&generate-id"),
      Self::TurnSymbol => write!(f, "turn-symbol"),
      Self::TurnKeyword => write!(f, "turn-keyword"),
      ...
      Self::NativeTuple => write!(f, "&tuple"),
      ...
      Self::NativeRecord => write!(f, "&record"),
