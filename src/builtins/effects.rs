...
use crate::{
  calcit::{Calcit, CalcitCompactList, CalcitErr},
...
pub fn raise(xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
...
pub fn cpu_time(_xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
  let now = Instant::now();
...
pub fn calcit_running_mode(_xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
...
// TODO
pub fn call_get_calcit_backend(_xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
  Ok(Calcit::tag("rust"))
}

pub fn quit(xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
  match xs.get(0) {
...
pub fn get_env(xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
  if xs.len() > 2 {
...
pub fn read_file(xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
  match xs.get(0) {
...
pub fn write_file(xs: &CalcitCompactList) -> Result<Calcit, CalcitErr> {
