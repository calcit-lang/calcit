...
fn handle_proc_internal(name: CalcitProc, args: &[Calcit], call_stack: &CallStackList) -> Result<Calcit, CalcitErr> {
  ...
  match name {
    ...
    NativeF64BufferLen => meta::f64_buffer_len(args),
    NativeF64ToI64Index => meta::f64_to_i64_index(args),
    NativeF64BufferGet => meta::f64_buffer_get(args),
    ...
    // enums
    NativeEnum => meta::new_enum_value(args), // unstable solution for the name
    NativeNamedEnumNew => meta::new_named_enum_value(args),
    NativeEnumNth => meta::enum_nth(args),
    NativeEnumAssoc => meta::assoc(args),
    NativeEnumCount => meta::enum_count(args),
    NativeEnumImpls => meta::enum_impls(args),
    NativeEnumParams => meta::enum_params(args),
    NativeEnumDefinition => meta::enum_definition(args),
    ...
    NativeStructValueImplTraits => meta::record_impl_traits(args),
    NativeEnumValueImplTraits => meta::tuple_impl_traits(args),
    NativeStructImplTraits => meta::struct_impl_traits(args),
    NativeEnumImplTraits => meta::enum_impl_traits(args),
    NativeEnumDefHasVariant => meta::enum_def_has_variant(args),
    NativeEnumDefVariantArity => meta::enum_def_variant_arity(args),
    NativeEnumValidate => meta::enum_validate(args),
    ...
    NativeStructGetName => structs::get_struct_name(args),
    NativeStructDefinition => structs::get_struct_def(args),
    NativeStructToMap => structs::turn_map(args),
    NativeStructMatches => structs::matches(args),
    NativeStructCount => structs::count(args),
    NativeStructContains => structs::contains_ques(args),
    NativeStructGet => structs::get(args),
    NativeStructNth => structs::struct_nth(args),
    NativeStructFieldTag => structs::struct_field_tag(args),
    NativeStructAssoc => structs::assoc(args),
    NativeStructAssocAt => structs::struct_assoc_at(args),
    NativeStructWithAt => structs::struct_with_at(args),
    NativeStructExtendAs => structs::extend_as(args),
