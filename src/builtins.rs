...
fn handle_proc_internal(name: CalcitProc, args: &[Calcit], call_stack: &CallStackList) -> Result<Calcit, CalcitErr> {
  ...
  match name {
    ...
    NativeTupleWithImpls => meta::tuple_with_impls(args),
    ...
    NativeStructWithImpls => meta::struct_with_impls(args),
    NativeEnumWithImpls => meta::enum_with_impls(args),
    NativeRecordWithTraits => meta::record_with_traits(args),
    NativeTupleWithTraits => meta::tuple_with_traits(args),
    NativeStructWithTraits => meta::struct_with_traits(args),
    NativeEnumWithTraits => meta::enum_with_traits(args),
    ...
    NativeRecordWithImpls => records::with_impls(args),
