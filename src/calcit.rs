...
pub use type_annotation::{
  ...
  MacroSyntaxType, SchemaKind, brief_type_of_value, clear_type_slots, configure_entry_type_slots, pop_type_slot_override,
  push_type_slot_override, register_program_lookups, register_type_slot, resolve_type_slot, value_matches_type_annotation,
