...
- Measured core delta: binary targets `4 → 3`, direct dependencies remain `31`, and the release `calcit` binary remains exactly `9,515,920` bytes. Removing a separate runner target does not change runtime payload.
