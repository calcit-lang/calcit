...
在 benchmark harness commit `68638119` 的干净工作区上采集首份完整 Calcit→Calx scalar baseline。
...
The first complete Calcit-to-Calx scalar baseline was collected from a clean worktree at benchmark-harness commit `68638119`.
