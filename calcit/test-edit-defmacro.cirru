    ...
    'app.main $ %{} 'FileEntry
      :defs $ {}
        'main! $ %{} 'CodeEntry (:doc |)
          ...
          :tests $ []
            %{} 'TestEntry (:name |required-expands)
              :code $ quote
                assert= 1 $ required-id 1
              :tags $ #{} :macro-edit
            %{} 'TestEntry (:name |optional-expands)
              :code $ quote
                assert= 2 $ optional-id 2 20
              :tags $ #{} :macro-edit-compat
            %{} 'TestEntry (:name |rest-expands)
              :code $ quote
                assert= 3 $ rest-id 3 4 5
              :tags $ #{} :macro-edit
        'optional-id $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defmacro optional-id (value ? ignored) value
          :examples $ []
          :schema $ :: 'Macro
            {}
              :capabilities $ #{}
        ...
        'required-id $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defmacro required-id (value) value
          :examples $ []
          :schema $ :: 'Macro
            {}
              :capabilities $ #{}
        ...
        'rest-id $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defmacro rest-id (value & ignored) value
          :examples $ []
          :schema $ :: 'Macro
            {} (:rest 'Syntax)
              :capabilities $ #{}
