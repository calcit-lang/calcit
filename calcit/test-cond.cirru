...
{}
  ...
  :entries $ {} $ :default
    {} (:description |) (:init-fn 'test-cond.main/main!) (:mode :native) (:reload-fn 'test-cond.main/reload!)
      ...
      :modules $ [] |./util.cirru
      :type-slots $ {}
  :files $ {} $ 'test-cond.main
    %{} 'FileEntry
      :defs $ {}
        'main! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defwasm-export main! () (log-title "|Testing cond") (test-when) (test-cond) (test-or) (test-and) (test-either) (test-case) (test-match) true
          :examples $ []
          :schema $ :: 'Dynamic
        'test-and $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing and")
            assert= (and 1) 1
        ...
        'test-either $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing either")
        ...
        'test-match $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing match")
            ; println |EXPANDED $ format-to-cirru $ macroexpand-all
              quote $ match (:: :a 1)
                (:a x) 1
                (:a x y) 2
                _ :none
        ...
        'test-or $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing or")
            assert= (or 1) 1
            assert= (or nil) nil
            assert= (or 1 nil) 1
            assert= (or nil 1) 1
        ...
        'test-when $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing when")
          ...
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns test-cond.main
          :require $ util.core :refer $ inside-eval: log-title
