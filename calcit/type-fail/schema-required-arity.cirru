...
{}
  ...
  :entries $ {} $ :default
    {} (:description |)
      :init-fn 'type-fail-schema-required-arity.main/main!
      :mode :native
      :reload-fn 'type-fail-schema-required-arity.main/reload!
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
      ...
      :defs $ {}
        'bad-arity $ %{} 'CodeEntry
          ...
          :schema $ :: 'Fn $ {} (:return 'Number)
            :args $ [] 'Number 'Number
        'main! $ %{} 'CodeEntry
          :doc "|Entry for type-fail schema arity mismatch"
        ...
        'reload! $ %{} 'CodeEntry (:doc "|Reload handler")
          ...
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
      :ns $ %{} 'NsEntry
        :doc "|Namespace for schema arity mismatch"
