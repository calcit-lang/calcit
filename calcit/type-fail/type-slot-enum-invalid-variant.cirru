...
{}
  ...
  :package |type-fail-type-slot-enum-invalid-variant
  :entries $ {} $ :default
    {} (:description |)
      :init-fn 'type-fail-type-slot-enum-invalid-variant.main/main!
      :mode :native
      :reload-fn 'type-fail-type-slot-enum-invalid-variant.main/reload!
      :feature-policy $ {}
      :modules $ []
    ...
    %{} 'FileEntry
      :defs $ {}
        ...
        'legacy-main! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn legacy-main! ()
            with-type-slot (:dispatch-op Action) 1 2
          :examples $ []
          :schema $ :: 'Dynamic
        'main! $ %{} 'CodeEntry
          :doc "|Entry testing enum auto-rewrite via type-slot with invalid variant"
        ...
        'takes-action $ %{} 'CodeEntry
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ [] '*dispatch-op
      :ns $ %{} 'NsEntry
        :doc "|Namespace for type-slot enum invalid variant detection"
