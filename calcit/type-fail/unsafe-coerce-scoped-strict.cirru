...
{}
  ...
  :entries $ {} $ :default
    {}
      :description "|Strict preprocessing fixture for a lexically scoped unsafe host assertion."
    ...
    %{} 'FileEntry
      :defs $ {}
        'coerce-host $ %{} 'CodeEntry
          :doc "|The same assertion is allowed only in this marked adapter body."
          ...
          :schema $ :: 'Fn $ {} (:return 'String)
            ...
            :features $ #{} :js-ffi
        'main! $ %{} 'CodeEntry
          :doc "|Typed callers do not inherit or need the adapter capability."
