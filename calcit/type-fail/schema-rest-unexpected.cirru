...
{}
  ...
  :entries $ {} $ :default
    {} (:description |)
      :init-fn 'type-fail-schema-rest-unexpected.main/main!
      :mode :native
      :reload-fn 'type-fail-schema-rest-unexpected.main/reload!
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
      ...
      :defs $ {}
        'bad-rest $ %{} 'CodeEntry
          ...
          :schema $ :: 'Fn $ {} (:rest 'Number) (:return 'Number)
            :args $ [] 'Number
        'main! $ %{} 'CodeEntry
          :doc "|Entry for type-fail schema unexpected rest"
        ...
        'reload! $ %{} 'CodeEntry (:doc "|Reload handler")
          ...
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
      :ns $ %{} 'NsEntry
        :doc "|Namespace for schema unexpected rest"
