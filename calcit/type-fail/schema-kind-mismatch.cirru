...
{}
  ...
  :entries $ {} $ :default
    {} (:description |) (:init-fn 'type-fail-schema-kind-mismatch.main/main!) (:mode :native) (:reload-fn 'type-fail-schema-kind-mismatch.main/reload!)
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
  :files $ {} $ 'type-fail-schema-kind-mismatch.main
    %{} 'FileEntry
      :defs $ {}
        'bad-kind $ %{} 'CodeEntry (:doc "|Formatter-normalized function schema fixture.")
