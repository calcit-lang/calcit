...
{} (:about "|type-fail: code has & rest param but schema has no :rest") (:package |type-fail-schema-rest-missing)
      ...
      :defs $ {}
        ...
        |reload! $ %{} :CodeEntry (:doc "|Reload handler")
          ...
          :schema $ :: :fn
            {} (:return :unit)
              :args $ []
      :ns $ %{} :CodeEntry (:doc "|Namespace for schema rest mismatch") (:schema nil)
