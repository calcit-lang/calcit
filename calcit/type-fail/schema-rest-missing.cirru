...
{}
  ...
  :entries $ {} $ :default
    {} (:description |)
      :init-fn 'type-fail-schema-rest-missing.main/main!
      :mode :native
      :reload-fn 'type-fail-schema-rest-missing.main/reload!
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
      ...
      :defs $ {}
        'bad-rest $ %{} 'CodeEntry
          ...
          :schema $ :: 'Fn $ {} (:return 'List)
            :args $ []
        'main! $ %{} 'CodeEntry
          :doc "|Entry for type-fail schema rest mismatch"
        ...
        'reload! $ %{} 'CodeEntry (:doc "|Reload handler")
          ...
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
      :ns $ %{} 'NsEntry
        :doc "|Namespace for schema rest mismatch"
