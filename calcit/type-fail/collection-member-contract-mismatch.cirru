...
{}
  ...
  :entries $ {} $ :default
    {} (:description |) (:init-fn 'type-fail-collection-member-contract.main/main!) (:mode :native)
      ...
      :modules $ []
      :type-slots $ {}
  :files $ {} $ 'type-fail-collection-member-contract.main
    %{} 'FileEntry
      :defs $ {}
        'main! $ %{} 'CodeEntry
          :doc "|Reject mismatched collection lookup, membership, key, and association arguments"
        ...
        'partial-generic-check $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn partial-generic-check (items fallback) &unit
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ [] (:: 'Map 'T 'Number) 'T
            :generics $ [] 'T
        'partial-variadic-check $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn partial-variadic-check (& items) &unit
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
            :generics $ [] 'T
        ...
        'reload! $ %{} 'CodeEntry (:doc "|Reload handler")
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ []
      :ns $ %{} 'NsEntry
        :doc "|Namespace for collection member contract mismatches"
