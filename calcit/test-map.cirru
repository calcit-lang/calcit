...
{}
  ...
  :files $ {} $ 'test-map.main
    %{} 'FileEntry
      :defs $ {}
        'main! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defwasm-export main! () (log-title "|Testing maps") (test-maps) (log-title "|Testing map syntax") (test-native-map-syntax) (test-map-comma) (test-get) (test-shorthand) (test-filter-map-kv) (test-map-list-kv) (do true)
          :examples $ []
        ...
        'test-get $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing get")
            assert= (%none)
              get (&{}) :a
            assert= (%none)
              get-in (&{}) ([] :a :b)
        ...
        'test-map-list-kv $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn test-map-list-kv ()
            let
                lines $ map-list-kv
        ...
        'test-native-map-syntax $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn test-native-map-syntax ()
            inside-eval: $ assert=
        ...
        'test-shorthand $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ []
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns test-map.main
          :require $ [] util.core :refer $ [] log-title inside-eval: inside-js:
