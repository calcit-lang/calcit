    ...
    %{} 'FileEntry
      :defs $ {}
        ...
        'test-alias $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing alias")
            assert= (' 1 2 3) ([] 1 2 3)
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ []
        'test-doseq $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing doseq")
            inside-eval: $ =
              macroexpand $ quote $ &doseq
                n $ range 5
                println |doing: n
                swap! *counted &+ n
              quote $ apply
        ...
        'test-let[] $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing let[]")
            inside-eval: $ println $ format-to-lisp
              macroexpand $ quote $ let[] (a b c & d) ([] 1 2 3 4 5) (println a) (println b) (println c) (println d)
