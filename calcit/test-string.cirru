    ...
    %{} 'FileEntry
      :defs $ {}
        ...
        'test-char $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Test char")
        ...
        'test-format $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Testing format")
            ...
            inside-eval: (; TODO not stable)
              ; assert= "|({} (:c ([] 3)) (:a 1) (:b |2) (:d ({} (([] 1 2) 3))))" $ to-lispy-string $ {} (:a 1) (:b |2)
                :c $ [] 3
                :d $ {} $
                  [] 1 2
                  , 3
        ...
        'test-lisp-style $ %{} 'CodeEntry (:doc |)
          :code $ quote $ fn () (log-title "|Test lisp style")
            assert=
        ...
        'test-str $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns test-string.main
          :require $ util.core :refer $ inside-eval: inside-js: log-title
