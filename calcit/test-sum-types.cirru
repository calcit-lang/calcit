...
{}
  ...
  :entries $ {} $ :default
    {} (:description |) (:init-fn 'test-sum-types.main/main!) (:mode :native) (:reload-fn 'test-sum-types.main/reload!)
      ...
      :modules $ []
      :type-slots $ {}
  :files $ {} $ 'test-sum-types.main
    %{} 'FileEntry
      :defs $ {}
        'ActionImpl $ %{} 'CodeEntry (:doc |)
          :code $ quote $ let
              ActionTrait $ deftrait ActionTrait $ .describe :fn
            defimpl ActionImpl ActionTrait $ .describe $ fn (self)
              match self
        ...
        'ActionResult $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def ActionResult (impl-traits Result ActionImpl)
          :examples $ []
          :schema $ :: 'Dynamic
        ...
        'make-err $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn make-err (message) (%:: ActionResult :err message)
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ [] 'Dynamic
        'make-ok $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn make-ok (value) (%:: ActionResult :ok value)
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ [] 'Dynamic
        ...
        'summarize $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn summarize (action)
            match action
