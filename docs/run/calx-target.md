...
夸大了微型 kernel 差距。[compile profile](https://github.com/calcit-lang/calcit-calx-bench/blob/main/benchmarks/calx/20260831-compile-profile-macos-arm64.json)
...
基准命令、阶段定义和原始 JSON 格式见[独立 Calx benchmark 工具](./calx-benchmark.md)。
