...
清单包含 **278** 个 schema-Dynamic 位置，分布于 **193** 个定义。
...
| retain-reviewed/macro-system | 90 |
| retain-reviewed/open-data-boundaries | 22 |
| retain-reviewed/public-open-boundaries | 16 |
| retain-reviewed/runtime-internals | 49 |
...
| `calcit.core/%{}` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/&case` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/&case` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/&case` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/&doseq` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/&list-match-internal` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/&list-match-internal` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/&map:filter` | `schema.args.1.args.0.item` | unresolved | public-open-boundaries | retain-reviewed | The internal Map pair callback receives heterogeneous key/value slots in a List; keep the open item explicit until tuple or named pair typing can preserve both independent parameters. |
| `calcit.core/&map:to-list` | `schema.return.item.item` | unresolved | public-open-boundaries | retain-reviewed | A Map entry is a heterogeneous key/value pair, which a homogeneous List item type cannot represent without erasing one parameter; callers must narrow each slot. |
...
| `calcit.core/&struct-match-internal` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/&struct-match-internal` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/'` | `schema` | unresolved | compiler-forms | retain-reviewed | This compiler form consumes or produces code/syntax whose value shape is phase-dependent. |
| `calcit.core/->` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->%` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->%` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->%` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->>` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/->>` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/:` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/and` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/and` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/apply-args` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/assert` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/assert` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/assert-detect` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/assert-detect` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/case` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/case` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/case-default` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/case-default` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/case-default` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/cond` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/def` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/def` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/do` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/do` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/either` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/either` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/flipped` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/flipped` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/flipped` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/fn` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/if-let` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/if-let` | `schema.inputs.2.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/if-let` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/if-not` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/if-not` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/let` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let-destruct` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let-destruct` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let-destruct` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let-sugar` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let-sugar` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let[]` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let[]` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let[]` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let{}` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let{}` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/let{}` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/list-match` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/loop` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/loop` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/option:let` | `schema.expansion.type-arg.0` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/or` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/or` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/or` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/struct-match` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/struct-match` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/swap!` | `schema.inputs.0.expr.item` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/swap!` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/when` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when-let` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when-let` | `schema.expansion.type-arg.0` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when-not` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when-not` | `schema.rest.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/when-not` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/with-gensyms` | `schema.expansion` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
...
| `calcit.core/{,}` | `schema.expansion.key` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/{,}` | `schema.expansion.value` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/{}` | `schema.expansion.key` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/{}` | `schema.expansion.value` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.core/~` | `schema` | unresolved | compiler-forms | retain-reviewed | This compiler form consumes or produces code/syntax whose value shape is phase-dependent. |
| `calcit.core/~@` | `schema` | unresolved | compiler-forms | retain-reviewed | This compiler form consumes or produces code/syntax whose value shape is phase-dependent. |
| `calcit.internal/&core-add-list-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-add-number-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-add-string-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-compare-number-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-compare-string-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-enum-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-list-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-map-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-set-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-string-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-contains-struct-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-enum-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-list-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-map-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-set-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-string-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-countable-struct-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-debug-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-eq-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-len-list-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-len-map-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-len-set-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-len-string-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-mappable-list-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-mappable-map-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-mappable-set-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
| `calcit.internal/&core-multiply-number-impl` | `schema` | unresolved | runtime-internals | retain-reviewed | 编译器自有的 trait/impl 元数据不是公开值契约；保留可审阅的边界说明。 |
...
| `calcit.test/is` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/is-not=` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/is-not=` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/is-throws` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/is=` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/is=` | `schema.inputs.1.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
| `calcit.test/throws?` | `schema.inputs.0.expr` | intentional-macro-syntax | macro-system | retain-reviewed | 宏语法随展开阶段变化；保留显式开放边界，并通过专项测试验证语义。 |
